...
def find_target_deepfashion(model, args, index_ids, index_feats, c_id, caption):
    # init
    init_env(args)
    ...
    from train.src.dataset import  DeepFashionUserDataset
    query_dataset = DeepFashionUserDataset(
        test_root = args['test_root'],
        candidate = c_id,
        caption = caption,
